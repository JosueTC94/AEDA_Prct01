...
int vector::get_dimension(void)
{
  return dimension;
}
void vector::mostrar_elementos(void)
{
  if(vacio() != true)
  {
...
void vector::dimensionar(int dim)
{
  datos = new TDATO[10];
  dimension = dim;
}

void vector::insertar(int pos, TDATO dato)
{
  datos[pos] = dato;
}

void vector::eliminar_xpos(int pos)
{
  int i=pos;
  dimension--;
  while(i<dimension)
...
void vector::eliminar_dato(TDATO dat)
{
  int i=0;
...
void vector::buscar_dato(TDATO d)
{
  int i=0;
